...
import 'package:immoizi_app_user_tenant/src/i18n/tenant_strings.dart';
...
void main() {
  ...
  test('every tr() string in the tenant app has an English translation', () {
  ...
  testWidgets('switching language and theme from Mon espace', (tester) async {
    ...
    await tester.pumpAndSettle();
    final theme = Theme.of(tester.element(find.text('Explore')));
